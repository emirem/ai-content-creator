...
const server = z.object({
  ...
  TWITTER_APP_KEY_SECRET: z.string(),
...
const client = z.object({
  ...
  NEXT_PUBLIC_TWITCH_USERNAME: z.string(),
  // NEXT_PUBLIC_ELEVEN_LABS_API_KEY: z.string(),
  NEXT_PUBLIC_TWITCH_PASSWORD: z.string()
});
...
const processEnv = {
  ...
  NEXT_PUBLIC_TWITCH_USERNAME: process.env.NEXT_PUBLIC_TWITCH_USERNAME,
  NEXT_PUBLIC_TWITCH_PASSWORD: process.env.NEXT_PUBLIC_TWITCH_PASSWORD,
